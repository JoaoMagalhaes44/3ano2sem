...
def organizar_compositores_por_periodo(compositores):
    ...
    for compositor in compositores:
        if validar_compositor(compositor):
...
def corrigir_dataset(dataset):
    ...
    # Adiciona a seção "periodo" ao dataset
    dataset_completo = {"compositores": compositores_validos, "periodos": compositores_por_periodo}
