...
logic_operands = [
    ...
    'ZEROLESS',
    'ZEROGREATER',
    'INVERT', #passar de decimal para binario trocar os bits e voltar para decimal
    'FALSE',
    'TRUE'
]
...
states = (
   ('insidecomment','exclusive'), # nao se aplica o que é aplicado neste estado
)
